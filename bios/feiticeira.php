...
<head>
    <meta charset="UTF-8">
    <title>Homem-Aranha | Marvel Comics</title>
    ...
    <main class="container my-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <img src="biocapas/feiticeira.jpg" alt="Homem-Aranha" class="img-fluid rounded shadow">
            </div>

           
            <div class="col-md-8">
                <h1>Feiticeira Escarlate</h1>
                <h5 class="text-muted">Wanda Maximof</h5>
