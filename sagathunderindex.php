...
<head>
    ...
    <link rel="stylesheet" href="sagathunderindex.css">
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <a href="sagas_fase.php?fase=MESTRES DA ENGANAÇÃO&universo=thunderbolts" class="vingadores-link">
                    <div class="vingadores-card" style="background-image: url('sagasbanner/sagamestres.webp');">
                        <div class="overlay">
                            <h1>MESTRES DA ENGANAÇÃO</h1>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <a href="sagas_fase.php?fase=ANTI HERÓIS&universo=thunderbolts" class="vingadores-link">
                    <div class="vingadores-card" style="background-image: url('sagasbanner/sagaanti.jpg');">
                        <div class="overlay">
                            <h1>ANTI HERÓIS</h1>
                        </div>
                    </div>
            ...
            <div class="col-md-6 mb-4">
                <a href="sagas_fase.php?fase=REINADO SOMBRIO&universo=thunderbolts" class="vingadores-link">
                    <div class="vingadores-card" style="background-image: url('sagasbanner/sagacontrole.jpg');">
                        <div class="overlay">
                            <h1>REINADO SOMBRIO</h1>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <a href="sagas_fase.php?fase=ESQUADRÃO SUICIDA&universo=thunderbolts" class="vingadores-link">
                    <div class="vingadores-card" style="background-image: url('sagasbanner/sagasuicida.jpg');">
                        <div class="overlay">
